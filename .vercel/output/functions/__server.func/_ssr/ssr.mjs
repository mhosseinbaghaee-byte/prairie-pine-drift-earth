...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C4nt4qN_.mjs");
...
var manifest = {
	"219e45791ab663a67c9f72d785c784ba88f10bbae8fec56e7c2cebeaab631fcb": {
		functionName: "speakPouya_createServerFn_handler",
		importer: () => import("./ai-C4ZA3CBs.mjs")
	},
	"37ca95f500f98676e12fa6cba9976368fda36e5493ec0fa5816fc955f69e147b": {
		functionName: "dailyFact_createServerFn_handler",
		importer: () => import("./ai-C4ZA3CBs.mjs")
	},
	"43edcad30e7fee0c4d47e311d235a376d258312d6d9f27586d1c3cefefdfb059": {
		functionName: "askPouya_createServerFn_handler",
		importer: () => import("./ai-C4ZA3CBs.mjs")
	},
	"7706dc834ca3dea6541d1a8bf1cdb60a4caadbec4d7072d30b42ffde98d0f7ab": {
		functionName: "makeQuiz_createServerFn_handler",
		importer: () => import("./ai-C4ZA3CBs.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-QG-f7A1-.mjs").then((n) => n.t),
