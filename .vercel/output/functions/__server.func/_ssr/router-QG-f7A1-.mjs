...
//#region node_modules/.nitro/vite/services/ssr/assets/router-QG-f7A1-.js
var router_QG_f7A1__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-dvh flex-col items-center justify-center gap-3 bg-background px-6 text-center text-fg",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "یک خطای غیرمنتظره رخ داد. صفحه را دوباره بارگذاری کن."
			})
		]
	});
}
...
var styles_default = "/assets/styles-DjGpsEUj.css";
var APP_NAME = "پویا";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "مربی زنده دانش و آموزش عمومی"
			},
			{
				name: "theme-color",
				content: "#B4232A"
...
var $$splitComponentImporter = () => import("./routes-D2U5PvOI.mjs");
...
//#endregion
export { getRouter, router_QG_f7A1__exports as t };
