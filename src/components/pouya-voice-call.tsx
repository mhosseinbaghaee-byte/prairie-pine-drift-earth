import { MicOff, Minus, MoreVertical, X } from "lucide-react";
    ...
    >
      ...
      <div className="flex shrink-0 flex-col items-center gap-5 px-5 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
        ...
        <div className="flex w-full items-center gap-2">
          ...
          <form
            className="flex min-w-0 flex-1 items-center rounded-full bg-ink/45 px-4 py-1"
            onSubmit={(e) => {
              e.preventDefault();
              onSend(draft);
            }}
