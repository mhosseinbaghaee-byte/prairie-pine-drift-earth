...
export function PouyaMainApp() {
  ...
  return (
    ...
    >
        ...
        >
          {(
            ...
            <button
              ...
              title={label}
            >
              <Icon className="size-4 shrink-0" strokeWidth={tab === id ? 2.4 : 2} />
      ...
      <div className="mx-auto flex w-full min-w-0 max-w-lg flex-1 flex-col px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2 sm:px-4">
        {tab === "chat" ? (
          <ChatPane
            messages={messages}
            typed={typed}
