...
export function PouyaMainApp() {
  ...
  return (
    ...
    >
      <header
        className={cn(
          "flex shrink-0 items-center gap-3 px-3 py-2.5 sm:px-4",
          redShell
      ...
      >
            ...
            <div className="flex rounded-full border border-white/25 bg-white/15 p-0.5 backdrop-blur-md">
              {LEVELS.map((l) => (
                <button
                  ...
                  className={cn(
                    "h-8 min-h-8 rounded-full px-2.5 text-xs transition",
        ...
        <nav
          className={cn("pouya-glass-nav ms-auto", redShell && "pouya-glass-nav-on-red")}
          aria-label="بخش‌ها"
        >
          {(
            [
