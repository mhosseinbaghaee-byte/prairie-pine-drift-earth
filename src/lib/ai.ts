...
function systemPrompt(level: Level, mode: ChatMode, langId?: string, assistantId?: string) {
  ...
  return `${base}\n\nحالت گفتگو:\nقانون زبان (اجباری): به همان زبانی جواب بده که کاربر نوشته.\nاگر فارسی نوشت → فقط فارسی روان.\nاگر انگلیسی نوشت → انگلیسی.\nهرگز بدون درخواست صریح کاربر، مکالمه را به انگلیسی نکشان.\nاگر خواست فارسی حرف بزنی، فوراً فارسی ادامه بده.`;
}
