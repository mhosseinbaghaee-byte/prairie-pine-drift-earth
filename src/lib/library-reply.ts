...
// پوشش گسترده‌تر: عبارت مستقیم («خودکشی»)، محاوره‌ای («دیگه نمی‌خوام زنده باشم»)،
// روش آسیب («قرص بخورم تا بمیرم»)، و نشانه‌ی سوءاستفاده/گرومینگ («عکس‌های بد برام فرستاده»).
...
export function localTutorReply(opts: {
  ...
  if (metaHints.some((h) => lastLower.includes(h.toLowerCase()) || last.includes(h))) {
    return (
      ...
      "من انسان نیستم و حافظه شخصی واقعی ندارم — روی همین گفتگو کمکتم می‌کنم.\n\n" +
