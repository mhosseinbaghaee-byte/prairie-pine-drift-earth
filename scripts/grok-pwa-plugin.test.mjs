...
/**
 * A fresh directory with no site.json / public/og.jpg. Tests that exercise
 * default (no-override) behavior must use this instead of the implicit
 * process.cwd() fallback, or they silently pick up this project's real
 * src/lib/og/site.json and public/og.jpg and become non-deterministic.
 */
function emptyCwd() {
